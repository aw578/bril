...
for f in benchmarks/core/*.bril examples/test/lvn/*.bril; do
    echo "$f"
    args=""
    ...
    output2=$(bril2json < "$f" | python cs6120/lesson_3/lvn.py | python cs6120/lesson_3/dce.py | brili -p $args 2>/dev/null)  
